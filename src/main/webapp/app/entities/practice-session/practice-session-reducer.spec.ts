...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRACTICESESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRACTICESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRACTICESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRACTICESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRACTICESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRACTICESESSION actions', async () => {
      const expectedActions = [
        {
