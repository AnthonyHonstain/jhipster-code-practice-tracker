...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './practice.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRACTICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRACTICE actions', async () => {
      const expectedActions = [
        {
