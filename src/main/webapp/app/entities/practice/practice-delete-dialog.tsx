...
export const PracticeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="codePracticeTrackerApp.practice.delete.question">
        Are you sure you want to delete Practice {practiceEntity.id}?
      </ModalBody>
      <ModalFooter>
